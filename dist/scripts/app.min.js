...
var app=app||{};app.mainView=Backbone.View.extend({el:$("#main"),initialize:function(){var e=this;e.searchInput=$("#searchText"),e.searchBtn=$(".serachDiv a"),e.list=$("#services"),e.date=$("input[name='date_submit']"),e.quanity=$("#quanity"),e.period=$("#period"),e.readyToAddId="",e.addDiet=$("#addDiet"),e.addDietBtn=$("#addDiet .add"),e.foods=new app.foodList,e.searchResults=new app.searchList,e.foodRecords=new app.foodRecordList,e.loading=$(".loading"),e.totalCal=$("#totalCal span"),e.listenTo(e.foods,"reset",e.searchFoodRender),e.listenTo(e.searchResults,"reset",e.searchResultsRender),Backbone.on("editFood",this.editFood,this),Backbone.on("removeFoodRecord",this.removeFoodRecord,this),e.searchBtn.bind("click",function(){e.searchResults.abortSearch(),Backbone.history.fragment=="search/"+e.searchInput.val()?Backbone.history.loadUrl():app.router.navigate("search/"+e.searchInput.val(),{trigger:!0,replace:!0})}),e.quanity.bind("blur",function(){var o=e.foods.searchID(e.readyToAddId);o=1==o.length?o[0]:[],$("#detail .ttlqty").html($(this).val()*o.get("serving_qty")),$("#detail .cal").html($(this).val()*o.get("nutrient_value"))}),e.addDietBtn.bind("click",function(){var o=[];parseInt(e.quanity.val())>0&&""!==e.readyToAddId&&(o=1==(o=e.foods.searchID(e.readyToAddId)).length?o[0]:[],e.addFoodRecord(o,function(){e.addDiet.addClass("hide")}))}),e.searchInput.bind("keyup",function(){var o=$(this).val();$(".searchList").addClass("hide"),""!==o&&e.searchResults.getItems(o,function(){e.searchResultsRender([])})}),e.loading.addClass("hide")},searchResultsRender:function(e){var o=this,a=$(document.createDocumentFragment());e.length>0&&(o.searchResults.forEach(function(e){var o=new app.searchView({model:e});a.append(o.render().el)}),$(".searchList").html(a).removeClass("hide"))},searchFood:function(e){var o=this;""!==e&&(o.loading.removeClass("hide").addClass("processing"),o.foods.getItems(e,function(){o.searchFoodRender([])}))},searchFoodRender:function(e){var o=this,a=$(document.createDocumentFragment());e.length>0?o.foods.forEach(function(e){var o=new app.foodView({model:e});a.append(o.render().el)}):a.append("<li>Something wrong</li>"),o.render(a),o.loading.addClass("hide").removeClass("processing")},foodRecord:function(){var e=this,o=$(document.createDocumentFragment());e.foodRecords.forEach(function(e){var a=new app.foodRecordView({model:e});o.append(a.render().el)}),e.render(o)},foodRecordSearch:function(e){var o=this,a=o.foodRecords.getItemsByDate(e),d=$(document.createDocumentFragment());o.totalCal.html(a.total),a.foods.forEach(function(e){var o=new app.foodRecordView({model:e});d.append(o.render().el)}),o.render(d)},render:function(e){return this.list.append(e),this},editFood:function(e){this.readyToAddId=e},addFoodRecord:function(e,o){var a=this,d=new app.foodRecord({date:a.date.val(),period:a.period.val(),quanity:a.quanity.val(),food:e});d.save({dataType:"json"},{success:function(e,a,d){console.log("The model has been saved to the server"),o()},error:function(e,o,a){console.log("Something went wrong while saving the model")}}),a.foodRecords.push(d)},removeFoodRecord:function(e){e.destroy()}});
function getDate(t){var e=t.getFullYear(),a=t.getMonth()+1,s=t.getDate();return a=(a<10?"0":"")+a,s=(s<10?"0":"")+s,e+"-"+a+"-"+s}var root=root||{},app=app||{};app.url="http://localhost";var myRouter=Backbone.Router.extend({initialize:function(){this.app=new app.mainView,this.serachPanel=$(".serachDiv"),this.tool=$("#tool"),this.period=$("#period"),this.calendar=$(".days"),this.list=$("#services"),this.detail=$("#detail"),this.searchText=$("#searchText"),this.searchList=$(".searchList"),this.total=$("#totalCal");var t=new Date,e=t.getTime();this.today=getDate(t);for(var a=[this.today],s=1;s<=6;s++)a.push(getDate(new Date(e-864e5*s)));this.calendar.html(a.reduce(function(t,e,a){return'<li data-day="'+e+'"><a href="#foodRecordDate/'+e+'">'+e.substr(8,2)+"</a></li>"+t},"")),$(".datepicker").val(this.today)},init:function(){this.serachPanel.addClass("hide"),this.calendar.addClass("hide"),this.tool.addClass("hide"),this.searchList.addClass("hide"),this.total.addClass("hide"),this.list.empty(),this.searchList.empty(),this.detail.empty()},routes:{"":"seachfoodRecordByDate","startSearch/:period":"startSearch","search/:value":"searchFood","foodRecordDate/:date":"seachfoodRecordByDate"},startSearch:function(t){this.init(),this.serachPanel.removeClass("hide"),this.period.val(t)},searchFood:function(t){this.init(),this.searchText.val(t),this.serachPanel.removeClass("hide"),this.app.searchFood(t)},seachfoodRecordByDate:function(t){t||(t=this.today),this.init(),this.tool.removeClass("hide"),this.calendar.removeClass("hide"),this.total.removeClass("hide"),this.calendar.find("li").each(function(e,a){t===$(a).data("day")?$(a).addClass("cur"):$(a).removeClass("cur")}),this.app.foodRecordSearch(t)}});$(document).ready(function(){root.localStorage=localStorage,$(".closeAddDiet").bind("click",function(){$("#addDiet").addClass("hide"),$("#quanity").val(1)}),$(".openTool").bind("click",function(){$(".toolList").toggleClass("active")}),app.router=new myRouter,Backbone.history.start()});