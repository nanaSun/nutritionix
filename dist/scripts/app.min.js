...
var app=app||{};app.foodList=Backbone.Collection.extend({model:app.food,url:"",getChecked:function(){return this.where({checked:!0})},getItems:function(e,t){this.url=app.url+"?action=s&q="+e,this.fetch({reset:!0,error:function(){t()}})},search:function(e){return this.filter(function(t){return t.get("title")===e})},searchID:function(e){return this.filter(function(t){return t.get("resource_id")===e})}});
...
var app=app||{};app.searchList=Backbone.Collection.extend({model:app.search,url:"",initialize:function(){this.fetchXRH=null},getItems:function(t,e){this.abortSearch(),this.url=app.url+"?action=a&q="+t,this.fetchXRH=this.fetch({reset:!0,error:function(){e()}})},abortSearch:function(){null!==this.fetchXRH&&this.fetchXRH.abort()}});
